        ...
        >
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className=' relative flex flex-col border border-(--color-secondary) bg-(--color-primary) w-[92%] h-[98%]'>
                <div className='flex flex-col h-18 mb-2 w-full border-b border-(--color-secondary)'>
                  <h3 className='pl-2'>{project.title}</h3>
                </div>
                <div className=' flex flex-col'>
                  <div className='flex flex-col gap-2 lg:gap-6 lg:flex-row '>
                    <div className='pl-2 order-1 lg:order-2 lg:w-1/2 lg:h-full'>
                      {project.mediaType === "video" ? (
                        <video
                          ...
                          loop
                          playsInline
                          className='w-full h-52 object-cover md:h-64'
                        />
                      ) : (
                        <img
                          src={project.mediaSrc}
                    ...
                    <div className='flex flex-col h-full order-2 lg:order-1 lg:w-1/2 lg:gap-2'>
                ...
                <div className='absolute left-1 bottom-3 flex flex-wrap pl-2 gap-2 pt-4 shrink-0 lg:w-[40%]'>
